...
import {
  ...
  type DateValue as MantineDateValue,
 ...
 */
export const Form = ({ extras, validationErrors = {}, children, ...props }: FormElementProps) => {
  return (
    <form {...props}>
...
type CollectionCheckboxesFieldProps = RailsCollectionCheckboxesField & InputProps
...
type CollectionRadioButtonsFieldProps = RailsCollectionRadioButtonsField & InputProps
...
export type TextFieldProps = ComponentProps<typeof MantineTextInput> & RailsTextField & InputProps
/**
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const TextField = ({ type: _type, label, errorKey, ...rest }: TextFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)

  return <MantineTextInput label={label} type={"text"} error={errorMessage} {...rest} />
}

export type EmailFieldProps = ComponentProps<typeof MantineTextInput> & RailsEmailField & InputProps
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const EmailField = ({ type: _type, label, errorKey, ...rest }: EmailFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const ColorField = ({ type: _type, label, errorKey, ...rest }: ColorFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)
  return <MantineColorInput label={label} error={errorMessage} {...rest} />
}

export type DateFieldProps = ComponentProps<typeof MantineDateInput> & RailsDateField & InputProps
...
export type DateTimeLocalFieldProps = ComponentProps<typeof MantineDateTimePicker> &
...
export type TimeFieldProps = ComponentProps<typeof MantineTimeInput> & RailsTimeField & InputProps
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const TimeField = ({ type: _type, label, errorKey, ...rest }: TimeFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const SearchField = ({ type: _type, label, errorKey, ...rest }: SearchFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)

  return <MantineTextInput label={label} type="search" error={errorMessage} {...rest} />
}

export type TelFieldProps = ComponentProps<typeof MantineTextInput> & RailsTelField & InputProps
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const TelField = ({ type: _type, label, errorKey, ...rest }: TelFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)

  return <MantineTextInput label={label} type="tel" error={errorMessage} {...rest} />
}

export type UrlFieldProps = ComponentProps<typeof MantineTextInput> & RailsUrlField & InputProps
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const UrlField = ({ type: _type, label, errorKey, ...rest }: UrlFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)
...
export type NumberFieldProps = Omit<ComponentProps<typeof MantineNumberInput>, "type"> &
  RailsNumberField &
  InputProps
/**
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const NumberField = ({ type: _type, label, errorKey, ...rest }: NumberFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)

  return <MantineNumberInput {...rest} label={label} error={errorMessage} />
}

export type PasswordFieldProps = typeof MantinePasswordInput & RailsPasswordField & InputProps
export const PasswordField = ({
  ...
  const errorMessage = useErrorMessage(errorKey)
  const inputProps: { inputSize?: string } = {}
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export const MultiSelect = (props: ComponentProps<typeof MantineMultiSelect>) => {
  const [values, setValues] = useState<string[]>(props.value || props.defaultValue || [])
  ...
  return (
    <>
      ...
      />
      {values.map((val) => (
        <input type="hidden" key={val} name={name} value={val} autoComplete="off" />
      ))}
    </>
  )
}
...
type SelectProps = ((SingleProps & RailsSingleSelect) | (MultiProps & RailsMultiSelect)) &
  InputProps
...
type TextAreaProps = ComponentProps<typeof MantineTextArea> & RailsTextArea & InputProps
...
export const FileField = ({ type: _type, errorKey, label, ...rest }: FileFieldProps) => {
  const errorMessage = useErrorMessage(errorKey)

  return <MantineFileInput label={label} error={errorMessage} {...rest} />
}

type SubmitButtonProps = ComponentProps<typeof MantineButton> & RailsSubmitButton
