...
- **Tech Stack:** Ruby 3.4.5, Rails 8.1, Superglue, Tailwind CSS
- **Architecture:**
  - `app/views/` – Rails ERB views, Superglue JSON props (you READ and STYLE here)
  - `app/frontend/` – React/TypeScript frontend (you coordinate with, but do not modify directly)
  - `app/assets/` – Stylesheets and manifests (you READ and ADD here)
